...
Usage:
    ...
    python3 scripts/update_gpu_ids.py --source github  # Use GitHub mirror instead
"""
...
def generate_gpu_ids_sh(arch_devices: dict[str, list[str]], total_pci_devices: int) -> str:
    ...
    lines = [
        ...
        f"# Source: https://pci-ids.ucw.cz/ (vendor {NVIDIA_VENDOR_ID})",
        f"# Generated: {now}",
...
def main():
    ...
    # Generate output
    output = generate_gpu_ids_sh(arch_devices, len(devices))
